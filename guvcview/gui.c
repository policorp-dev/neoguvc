...
static pthread_mutex_t guimtx = PTHREAD_MUTEX_INITIALIZER;
int gui_has_closed = 0; // make sure gui_close is only called once
...
/*default camera button action: DEF_ACTION_IMAGE - save image; DEF_ACTION_VIDEO
 * - save video*/
 ...
 */
int get_video_codec_ind() { return my_video_codec_ind; }
 ...
 * returns: current codec index
 */
int get_audio_codec_ind() { return my_audio_codec_ind; }
 ...
 */
int get_default_camera_button_action() { return default_camera_button_action; }
 ...
 */
int get_video_sufix_flag() { return video_sufix_flag; }
 ...
 * returns: none
 */
void set_video_sufix_flag(int flag) { video_sufix_flag = flag; }
 ...
 * returns: video muxer
 */
int get_video_muxer() { return video_muxer; }
 ...
 * returns: none
 */
void set_video_muxer(int muxer) { video_muxer = muxer; }
 ...
 */
int get_photo_sufix_flag() { return photo_sufix_flag; }
 ...
 * returns: none
 */
void set_photo_sufix_flag(int flag) { photo_sufix_flag = flag; }
 ...
 */
int get_photo_format() { return photo_format; }
 ...
 * returns: none
 */
void set_photo_format(int format) { photo_format = format; }
 ...
 */
void gui_close() {
  pthread_mutex_lock(&guimtx);
  if (gui_has_closed == 0) {
    gui_has_closed = 1;
  } else {
    pthread_mutex_unlock(&guimtx);
    return;
  }
  pthread_mutex_unlock(&guimtx);
